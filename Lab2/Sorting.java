public class Sorting {
     ...
     *
     * This method swaps the elements at the specified positions (i and j)
     * within the given integer array (A). It exchanges the values at A[i] and
     * A[j] by temporarily storing the value of A[i] in a temporary variable,
     * then assigning the value of A[j] to A[i], and finally assigning the
     * temporary value to A[j].
     *
     ...
     * standard output stream, separated by spaces, followed by a newline
     * character to create a visually formatted list of the array's contents.
     *
     ...
     * subarray defined by the given start and end indices in the provided
     * integer array (A). It iterates through the elements within the specified
     * range and maintains the index of the smallest element encountered. The
     * index of the smallest element is returned as the result.
     *
     ...
     *
     * This method sorts the given integer array (A) in ascending order using
     * the Selection Sort algorithm. It iteratively selects the smallest element
     * from the unsorted part of the array and swaps it with the element at the
     * beginning of the unsorted part, effectively partitioning the array into
     * sorted and unsorted sections.
     *
     * @param A The integer array to be sorted.
     */

	// Ex 1a Complete the method SelectionSort
     ...
     *
     * This method sorts the given integer array (A) in ascending order using
     * the Insertion Sort algorithm. It iteratively builds a sorted subarray by
     * shifting elements one at a time and inserting them into their correct
     * positions within the sorted part of the array.
     *
     * @param A The integer array to be sorted.
     */

	// Ex 1b Complete the method InsertionSort
     ...
     *
     * This method sorts the given integer array (A) in ascending order using
     * the Merge Sort algorithm. It recursively divides the array into smaller
